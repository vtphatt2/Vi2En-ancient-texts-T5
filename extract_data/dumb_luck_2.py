...
def post_map_wrong_text_to_correct_text(text):
    ...
    replacement_pairs = [
        ...
        ("away Moving", "away. Moving"),
        ("Th,.", "Thu"),
        ("friends again,", "friends again."),
        ("king!'?", "king"),
        ("enthusiasm.", "enthusiasm:"),
        ("Party.\" Even", "Party.\"\nEven"),
        ("replied, \"but", "replied. \"but"),
        ("calm down.", "calm down:"),


        ("rằng: “Em chã! Em chã!...”", "rằng:\n-\"Em chã! Em chã!...\"\n"),
        ("quát thét:", "quát thét."),
        ("Gớm! Vừa", "Gớm!\n- Vừa"),
        ("tự, thì", "tự. Thì"),
        ("La, sở", "La. Sở"),
        ...
        ("LẲNG LƠ", "LẲNG LƠ."),
        ("diện, đến", "diện. Đến"),
        (": “chỉ có ba ta thôi?” “Ba", ":\n- Chỉ có ba ta thôi?\n-Ba"),
        ("tử bột!”", "tử bột!\n"),
        ("sao? Thánh", "sao?\n- Thánh"),
        ("vội tâng công:", "vội tâng công."),
        ("đến, chứ", "đến.\n- Chứ"),
        ("Sao? Hay", "Sao?\n- Hay"),
        ("nữa! Tuyết", "nữa!\n- Tuyết"),
        ("số lắm. Tôi", "số lắm.\n- Tôi"),
        ("Con V~t magazine.", "Con Vẹt magazine:"),
        ("Phắc - tơ", "Phắc-tơ"),
        ("Dưới bài ấy đề dịch truyệnLa Patronne củaG. de Maupassant, dịch truyệnLe crime au père Boniface củaG. de Maupassant.", "Dưới bài ấy đề dịch truyện La Patronne của G.de Maupassant."),
        ("đọc? Họ", "đọc?\n- Họ"),
        ("tôi! Xấu", "tôi!\n- Xấu"),
        ("của bà Phó Ðoan:", "của bà Phó Ðoan."),
        ("lắm! Cậu", "lắm!\n- Cậu"),
        ("giòng ấy, Xuân", "giòng ấy. Xuân"),
        ("face away.", "face away:"),
        ("addressed the guests.", "addressed the guests:"),
        ("doctor's introduction.", "doctor's introduction"),
        ("her.)", "her)."),
        ("(Applause.)", "(Applause).\""),
        ("why they occur.", "why they occur\"\n"),
        ("impotent. What", "impotent; What"),
        ("witchcraft...","witchcraft...\"\n"),        
        ("his right hand.", "his right hand:"),
        ("Smacked in the Face", "Smacked in the Face."),
        ("S.M. Projadophick", "SM Projadophick,"),
        ...
        ("vỗ tay:", "vỗ tay."),
        ("tập giấy:", "tập giấy."),
        ("“trong một đời, người", "- Trong một đời, người"),
        ("“Bởi thế cho nên", "- Bởi thế cho nên"),
        ("“Nếu người chồng", "- Nếu người chồng"),
        ("xưa!...”", "xưa!...\n"),
        ("sao, vì", "sao. Vì"),
        ("hiền, nghĩa", "hiền. Nghĩa"),
        ("BỊ ÐẤM", "BỊ ÐẤM."),
        ("báo, trông", "báo. Trông"),
        ("lại, một", "lại. Một"),
        ("Th,!", "Thu."),
        ("cục, cũng", "cục. Cũng"),
        ("mục đích rồi.", "mục đích rồi,"),
        ("lắm, vì nếu", "lắm. Vì nếu"),
        ("ởséc đầu, Xuân", "ở séc đầu. Xuân"),
        ("Xuân, còn", "Xuân. Còn"),
        ("làm lo. Kết quả 5 - 7", "làm lo: Kết quả 5-7."),
        ("trọng tài hô 15 - 30", "trọng tài hô 15-30"),
        ("thua, vua", "thua. Vua"),
        ("thào“La guerre! La guerre!”.", "thào:\n- La guerre! La guerre!"),
        ("đã! Cái", "đã!\n- Cái"),
        ("trời, giữa", "trời. Giữa"),
        ("vítthì", "vít. Thì"),
        ("bóng, ông", "bóng. Ông"),
        ("Thưa đi! Nhường", "Thua đi!\n- Nhường"),
        ("Chông chúng đương hồi hộp vì 7 - 7, 7 - 8,", "Công chúng đương hồi hộp vì 7-7, 7-8."),
        ("Kết quả thảm khốc 7 - 9", "Kết quả thảm khốc 7-9"),
        ("Nhưng...", "Nhưng"),
        ("khí) Chính", "khí).\nChính"),
        ("Ðoan, rồi", "Ðoan. Rồi"),
        ("tuế! Sự", "tuế!\n- Sự"),
        ("vặn bà vợ hủ lậu:", "vặn bà vợ hủ lậu."),
        ("chưa? Tôi", "chưa?\n- Tôi"),
        ("thua? Thằng", "thua?\n- Thằng"),
        ("Thua! Nhưng", "Thua!\n- Nhưng"),
        ...
        ("the court...-9.", "the court... The result was 7-9,"),
        ("Siamese champion.", "Siamese champion,"),
        ("to see Xuan.", "to see Xuan:"),
        ("him bitterly.", "him bitterly,"),
        ("\"Down with Red-Haired Xuan!\"", "\"Down with Red-Haired Xuan!\"\n"),
        ("speak first.", "speak first:"),
        ("lose.\" The", "lose.\"\nThe"),
        ("over his head.", "over his head:"),
        ("ous voice.", "ous voice:"),
        ("\"Oh, my people", "Oh, my people"),
        ("Nations!\"", "Nations!"),
        ("resentment toward Xuan.", "resentment toward Xuan;"),
        ("throat and spit.", "throat and spit;"),
        ("\"No way.\"", "\"No way.\"\n"),
        ("dignified voice,", "dignified voice."),

        ("ngài, bản", "ngài.\n- Bản"),
        (": “Phải, ai đấm vào mặt mình bây giờ?”", ":\n- Phải, ai đấm vào mặt mình bây giờ?\n"),
        ("lắm. Ðể", "lắm.\n- Ðể"),
        ("lắm! Ðích", "lắm!\n- Ðích"),
        ("dám, ý", "dám. Ý"),
        ("tai Xuân:", "tai Xuân."),
        ("Cụ đến lúc ấy rồi m không được vênh váo thì giận thật.", ""),
        ("nữá Giá ai", "nữá. Giá ai"),
        ("các ông. Tôi", "các ông.\n- Tôi"),
        ("chịu, đứng lên:", "chịu, đứng lên."),
        ("dám! Thế", "dám!\n- Thế"),
        ("phái! Tôi", "phái!\n- Tôi"),
        ("là bình dân mà thôí", "là bình dân mà thôi."),
        ("lớn, tuy", "lớn.\n- Tuy"),
        ("trf tom", "tổ tôm"),
        ("được, tôi", "được.\n- Tôi"),
        ...
        ("on his bed.", "on his bed:"),
        ("kissed his son.", "kissed his son:"),
        ("Xuan added,", "Xuan added."),
        ("hands and cheered.", "hands and cheered:"),
        ("replied, \"It", "replied. \"It"),
        ("regards.", "regards\""),
...
def post_fix(text):
    ...
    replacement_pairs = [
        ...
        ("unison.\n\"the", "unison. \"the"),
        ("check.\nThe", "check. The"),
        ("North\"\nreferred", "North\" referred"),
        ("xuân\n- Một", "xuân, Một"),
        ("Việt\n- Xiêm", "Việt - Xiêm"),
        ("thiện\n- Ngự", "thiện, Ngự"),
        ("Tuần...\n(Bắc", "Tuần... (Bắc"),
        ("đây.\nÐông", "đây. Ðông"),
        ("Siam).\nVirtually", "Siam). Virtually"),
        ("Xiêm).\nCó", "Xiêm). Có"),
        ("nước!\nVà", "nước! Và"),
        ("ngoặt”.\nNhững", "ngoặt”. Những"),
        ("ta!\nHai", "ta! Hai"),
        ...
        ("out.\nLike", "out. Like"),
        ("ngaì.\nNó", "ngaì. Nó"),
        (" handkerchiefs.\nTransfixed", " handkerchiefs. Transfixed"),
        ("thấy.\nAnh", "thấy. Anh"),
        ("muội.\nAnh ta đứng cáh", "muội. Anh ta đứng cạnh"),
        ("râm!\nRõ", "râm! Rõ"),
        ("sunglasses!\nHe", "sunglasses! He"),
        ("đến.\nNgười", "đến. Người"),
        ("again.\n\"'Long", "again. \"'Long"),
        ("excitedly.\nQuick", "excitedly. Quick"),
        ("others.\n\"Vive", "others. \"Vive"),
        ("scarce.\nRumors", "scarce. Rumors"),
        ("đến...\nMọi", "đến... Mọi"),
        ("exclaimed.\n\"We", "exclaimed. \"We"),
        ("said.\n\"Read", "said. \"Read"),
        ("table.\n\"Hey,", "table. \"Hey,"),
        ...
        ("trọng, có", "trọng.\n- Có"),
        ("vit,\"\nthe referee", "vit,\" the referee"),
        ("oc-curred.\nXuan", "occurred: Xuan"),
        ("giới!\nNếu", "giới! Nếu"),
        ("qua!\nCho", "qua! Cho"),
        ("quần.\nTa", "quần. Ta"),
        ("congratu-lated Grandma.\n\"Grandma", "congratulated Grandma: \"Grandma"),
        ("được.\nCho nên cụ", "được. Cho nên cụ"),
        ("cùng.\nÐã", "cùng. Đã"),
        ("Ai?\nCụ", "Ai? Cụ"),
        ("belt.\nA wave", "belt. A wave"),
        ("Franco-Vietnamese.\n\"Ladies", "Franco-Vietnamese: \"Ladies"),
        ("the house.\nHe had", "the house. He had"),
        ("flag.\nThe car", "flag. The car"),
        ("house.\nThey were", "house. They were"),
        ("his servants.\n\"Prepare", "his servant. \"Prepare"),
        ("xe.\nKhi chiếc xe", "xe. Khi chiếc xe"),
        ("Officer.\nThe faithful", "Officer. The faithful"),
        ("Xuan added.\n\"She", "Xuan added. \"She"),
        ("her.\n\"Let us", "her. \"Let us"),
        ("forlorn.\nShe", "forlorn. She"),
        ("đâu!\nThan ôi", "đâu! Than ôi"),
        ("gì cả.\nBây giờ", "gì cả. Bây giờ"),
